   ...
   <body onload="setTimeout('init(<?php echo "$mjpegmode, $video_fps, $divider" ?>);', 100);">
      <div class="navbar navbar-inverse navbar-fixed-top" role="navigation" <?php getdisplayStyle('navbar', $userLevel); ?>>
         <div class="container">
            <div class="navbar-header">
               <a class="navbar-brand" href="#" style="color: white;">ĐI CHƠI THAM MỰ</a>
            </div>
         </div>
      </div>
	  <?php simple_button(); ?>
      <div class="container-fluid text-center liveimage">
         ...
         <div class="controller-btn">
            <button class="btn btn-success btn1 controller">forward</button>
            <button class="btn btn-success btn2 controller">backward</button>
            <button class="btn btn-success btn3 controller">right</button>
            <button class="btn btn-success btn4 controller">left</button>
            <button class="btn btn-danger btn-stop controller">Stop</button>
         </div>
